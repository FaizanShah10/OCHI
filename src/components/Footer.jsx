        ...
        <div data-scroll data-scroll-section data-scroll-speed=".5" className='h-screen flex '>
            <div className='w-1/2 h-full flex flex-col justify-between px-20 pt-32 pb-16'>
                <div className='heading'>
                    ...
                    <h2 className='text-8xl font-bold tracking-tighter leading-none'>OPENING</h2>
                </div>
            ...
            <div className='w-1/2'>
                <div className='heading pt-32 pb-16'>
                    <h2 className='text-8xl font-bold tracking-tighter leading-none'>PRESENTATIONS</h2>                 
                </div>


                <div className='links'>
                <p>S:</p>
                    <span className='links flex flex-col underline cursor-pointer mt-4 mb-8 mr-[10vw]'>
                    ...
                    <p>E:</p>
                    <span className='links flex flex-col underline cursor-pointer mt-4 mr-[10vw]'>
